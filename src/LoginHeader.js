  ...
  return (
    <div className="header__login">
      ...
      <div className="header__right__login">
        ...
        <Divider className="header__right__divider" orientation="vertical" variant="middle" flexItem />
        <button className="loginheader__join" onClick={() => setJoin(true)}>Join now</button>
